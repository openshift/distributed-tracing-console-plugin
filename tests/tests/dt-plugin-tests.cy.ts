...
describe('OpenShift Distributed Tracing UI Plugin tests', () => {
  before(() => {
    ...
    cy.get('.pf-v5-c-alert, .pf-v5-c-alert', { timeout: 120000 })
  ...
  it('Test Distributed Tracing UI plugin page without any Tempo instances', () => {
    ...
    cy.contains('.pf-v5-c-button', 'View documentation')
      .should('be.visible')
      .and('have.text', 'View documentation');

    cy.log('Assert create a tempo instance toggle visibility and text.');
    const createTempoToggle = cy.contains('.pf-v5-c-menu-toggle', 'Create a Tempo instance');
    ...
    cy.contains('.pf-v5-c-menu__item-text', 'Create a TempoStack instance')
      .should('be.visible')
      .and('have.text', 'Create a TempoStack instance');

    cy.contains('.pf-v5-c-menu__item-text', 'Create a TempoMonolithic instance')
      .should('be.visible')
  ...
  it('(Test Distributed Tracing UI plugin with Tempo instances and verify traces)', function () {
    ...
    cy.get(':nth-child(1) > .pf-v5-c-toolbar__item > .pf-v5-c-form > .pf-v5-c-form__group > .pf-v5-c-form__group-control > .pf-v5-c-menu-toggle > .pf-v5-c-menu-toggle__button > .pf-v5-c-menu-toggle__controls > .pf-v5-c-menu-toggle__toggle-icon').click();
    cy.get(':nth-child(2) > .pf-v5-c-menu__item > .pf-v5-c-menu__item-main > .pf-v5-c-menu__item-text').click();
    cy.get(':nth-child(1) > :nth-child(2) > .pf-v5-c-form > .pf-v5-c-form__group > .pf-v5-c-form__group-control > .pf-v5-c-menu-toggle > .pf-v5-c-menu-toggle__button').click();
    cy.get(':nth-child(2) > .pf-v5-c-menu__item > .pf-v5-c-menu__item-main > .pf-v5-c-menu__item-text').click();
    cy.get(':nth-child(2) > .pf-v5-c-form__group > .pf-v5-c-form__group-control > .pf-v5-c-menu-toggle > .pf-v5-c-menu-toggle__controls > .pf-v5-c-menu-toggle__toggle-icon').click();
    cy.get(':nth-child(1) > .pf-v5-c-menu__item > .pf-v5-c-menu__item-main > .pf-v5-c-menu__item-text').click();
    cy.get(':nth-child(1) > :nth-child(2) > .pf-v5-c-form > .pf-v5-c-form__group > .pf-v5-c-form__group-control > .pf-v5-c-menu-toggle > .pf-v5-c-menu-toggle__button > .pf-v5-c-menu-toggle__controls > .pf-v5-c-menu-toggle__toggle-icon').click();
    cy.get(':nth-child(1) > .pf-v5-c-menu__item > .pf-v5-c-menu__item-main > .pf-v5-c-menu__item-text').click();
    cy.get('.pf-v5-c-toolbar__group > :nth-child(1) > .pf-v5-c-form > .pf-v5-c-form__group > .pf-v5-c-form__group-control > .pf-v5-c-menu-toggle > .pf-v5-c-menu-toggle__controls > .pf-v5-c-menu-toggle__toggle-icon').click();
    cy.get(':nth-child(1) > .pf-v5-c-menu__item > .pf-v5-c-menu__item-main > .pf-v5-c-menu__item-text').click();
    cy.get('.pf-m-toggle-group > .pf-v5-c-toolbar__group > :nth-child(2) > .pf-v5-c-form > .pf-v5-c-form__group > .pf-v5-c-form__group-control > .pf-v5-c-menu-toggle > .pf-v5-c-menu-toggle__button').click();
    cy.contains('.pf-v5-c-menu__item-text', 'http')
      .closest('.pf-v5-c-menu__item')
      .find('input[type="checkbox"]')
      .check();
    cy.contains('.pf-v5-c-menu__item-text', 'grpc')
      .closest('.pf-v5-c-menu__item')
      .find('input[type="checkbox"]')
      .check();
    ...
    cy.get('.css-nesbvj').then(($el) => {
      cy.log(`Actual text in .css-nesbvj (TempoMonolithic): ${$el.text()}`);
    ...
    cy.get(':nth-child(1) > .pf-v5-c-form > .pf-v5-c-form__group > .pf-v5-c-form__group-control > .pf-v5-c-menu-toggle > .pf-v5-c-menu-toggle__button').click();
    cy.get(':nth-child(1) > .pf-v5-c-menu__item > .pf-v5-c-menu__item-main > .pf-v5-c-menu__item-text').click();
    cy.get(':nth-child(2) > .pf-v5-c-form__group > .pf-v5-c-form__group-control > .pf-v5-c-menu-toggle').click();
    cy.get(':nth-child(3) > .pf-v5-c-menu__item > .pf-v5-c-menu__item-main > .pf-v5-c-menu__item-text').click();
    cy.get('.pf-m-space-items-sm > :nth-child(2) > .pf-v5-c-form > .pf-v5-c-form__group > .pf-v5-c-form__group-control > .pf-v5-c-menu-toggle > .pf-v5-c-menu-toggle__button > .pf-v5-c-menu-toggle__controls > .pf-v5-c-menu-toggle__toggle-icon').click();
    cy.get(':nth-child(1) > .pf-v5-c-menu__item > .pf-v5-c-menu__item-main > .pf-v5-c-menu__item-text').click();
    cy.get('.pf-v5-c-toolbar__group > :nth-child(1) > .pf-v5-c-form > .pf-v5-c-form__group > .pf-v5-c-form__group-control > .pf-v5-c-menu-toggle > .pf-v5-c-menu-toggle__controls > .pf-v5-c-menu-toggle__toggle-icon > .pf-v5-svg').click();
    cy.get(':nth-child(1) > .pf-v5-c-menu__item > .pf-v5-c-menu__item-main > .pf-v5-c-menu__item-text').click();
    cy.get(':nth-child(2) > .pf-v5-c-form__group > .pf-v5-c-form__group-control > .pf-v5-c-menu-toggle > .pf-v5-c-menu-toggle__controls > .pf-v5-c-menu-toggle__toggle-icon').click();
    cy.get(':nth-child(1) > .pf-v5-c-menu__item > .pf-v5-c-menu__item-main > .pf-v5-c-menu__item-text').click();
    cy.get('.MuiDataGrid-row--firstVisible > [data-field="name"] > .MuiBox-root > .MuiTypography-root').click();
